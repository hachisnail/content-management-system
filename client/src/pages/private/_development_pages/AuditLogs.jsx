...
import ComponentErrorBoundary from "../../../../components/ComponentErrorBoundary"; // <--- IMPORT
import {
  DataTable,
  Badge,
  Button,
    ...
    },
    {
      ...
      render: (log) => (
        <div className="flex flex-col items-start gap-1">
          ...
          <div
            className="text-[11px] text-zinc-500 line-clamp-1 max-w-[250px]"
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-zinc-200 pb-6">
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-1">
            Immutable ledger of system mutations and events.
          </p>
        </div>
          ...
          filterSlot={
            ...
            >
              <div className="w-48 font-sans">
                {["All", "CREATE", "UPDATE", "DELETE", "LOGIN", "LOGOUT"].map(
                  (op) => (
                    <button
                      key={op}
                      onClick={() =>
