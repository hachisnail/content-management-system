...
export const StatsGrid = ({ usersCount, logsCount }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <h3 className="text-3xl font-bold text-zinc-900 mt-1">{usersCount || '...'}</h3>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <h3 className="text-3xl font-bold text-zinc-900 mt-1">{logsCount || '...'}</h3>
      </div>
    </div>
  );
};